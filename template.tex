...
\definecolor{header}{olive}{0.55}
\definecolor{rowgray}{gray}{0.95}

% Alternating colors starting from second row
\AtBeginEnvironment{longtable}{
  \rowcolors{2}{white}{rowgray}
  \setlength{\arrayrulewidth}{0.4pt}
}

% Control row colors around headers
\apptocmd{\toprule}{\hiderowcolors}{}{}
\apptocmd{\endhead}{\showrowcolors}{}{}
\apptocmd{\endfirsthead}{\showrowcolors}{}{}

% Patch header content to add rowcolor
\patchcmd{\endfirsthead}{\\}{\\\rowcolor{header}}{}{}
\patchcmd{\endhead}{\\}{\\\rowcolor{header}}{}{}
