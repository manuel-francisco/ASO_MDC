...
% Longtable coloring: alternate row colors and header background color
\AtBeginEnvironment{longtable}{
  \rowcolors{2}{white}{rowgray}
  \setlength{\arrayrulewidth}{0.4pt} % optional border thickness
}

% Disable alternating color during header rows to keep header clear
...
\patchcmd{\longtable}{\toprule}{\rowcolor{headergray}\toprule}{}{}
